...
create table Utilisateur(
    ...
    Photo varchar(500),
    Telephone int,
    AdresseMail varchar(50) NOT NULL check(AdresseMail like "%@%"),
...
create table Reponse(
    ...
    Identifiant varchar(30) NOT NULL,
    Texte varchar(10000) NOT NULL,
    date_Reponse char(10) NOT NULL check(date_Commentaire like "%%/%%/%%%%"),
...
create table Document(
    ...
    date_Document char(10) NOT NULL check(date_Commentaire like "%%/%%/%%%%"),
    Nom varchar(50),
